...
If you find yourself writing SeaORM logic directly inside a command function, stop and move it into `helpers.rs`. 
(or `db.rs` if the logic in helpers is not very clean.)
...
```sh
git clone https://github.com/tuxza/botplate.git
```
